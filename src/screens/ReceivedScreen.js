...
import TransactionCard from '../components/TransactionCard'; // <-- Import your Card

export default function ReceivedScreen() {
  const navigation = useNavigation();
  const [transactions, setTransactions] = useState([]);
  const STORAGE_KEY = '@received_transactions'; // <-- Define storage key
  ...
  const openAddModal = () => {
    navigation.navigate('AddReceived');
  };
